          ...
          >
            ...
            {!submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-2.5 sm:space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-1.5 sm:py-2 rounded-xl glass-input text-xs"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-1.5 sm:py-2 rounded-xl glass-input text-xs bg-[#0F172A] text-white"
                    >
                  ...
                  <button
                    ...
                    className="w-full py-2.5 sm:py-3 px-4 rounded-xl bg-gradient-to-r from-red-600 via-purple-600 to-cyan-600 hover:opacity-95 text-white font-bold text-xs uppercase tracking-wider transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer mt-0.5"
                  >
              ...
              <div className="text-center py-6 sm:py-8 space-y-3">
                ...
                <h3 className="text-base sm:text-lg font-bold text-white font-heading">Callback Requested!</h3>
                ...
                <button
                  onClick={handleClose}
                  className="px-5 py-2 rounded-xl bg-white/10 hover:bg-white/20 text-white font-semibold text-xs cursor-pointer mt-1"
                >
                  Close Window
                </button>
              </div>
